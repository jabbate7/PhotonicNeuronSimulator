...
htmlhelp_basename = 'PhotonicNeuronSimulatordoc'
...
man_pages = [
    (master_doc, 'photonicneuronsimulator', 'Photonic Neuron Simulator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PhotonicNeuronSimulator', 'Photonic Neuron Simulator Documentation',
     author, 'PhotonicNeuronSimulator', 'One line description of project.',
     'Miscellaneous'),
]
